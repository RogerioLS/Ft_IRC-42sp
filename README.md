...
For more details on the project's objectives and structure, please refer to the file. [objetivo_projeto.md](./readmes/objetivo_projeto.md).
...
**3.** You should use `epoll()` and only **once**.
...
| Command | Description |
| :-----------: | :----------- |
| Help | The `HELP` command is used to list all available commands. |
